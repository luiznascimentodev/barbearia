      ...
      try {
        if ($acao === 'confirmar' && $dados_agendamento['status'] === 'pendente') {
          ...
          if ($resultado) {
            ...
            $horario->reativarHorario($barbeiro_id, $dados_agendamento['data_agendamento'], $dados_agendamento['horario']);
    ...
    <div class="card-body">
      <form method="GET" class="row g-3">
        ...
        <div class="col-md-3 d-flex align-items-end">
          ...
          <a href="/barbeiro/agendamentos.php" class="btn btn-outline-secondary">
