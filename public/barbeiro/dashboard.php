    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="/barbeiro/agendamentos.php" class="btn btn-sm btn-outline-primary">
            Ver Todos
          </a>
        </div>
        <div class="card-body">
          ...
          <?php else: ?>
            <?php foreach ($proximos_agendamentos as $agend): ?>
              <div class="border-start border-3 border-primary ps-3 mb-3">
                <h6 class="mb-1"><?= htmlspecialchars($agend['cliente_nome']) ?></h6>
                <small class="text-muted">
                  <?= formatDate($agend['data_agendamento'] ?? $agend['data_hora']) ?> às <?= date('H:i', strtotime($agend['horario'] ?? $agend['data_hora'])) ?><br>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          <div class="d-grid gap-2">
            <a href="/barbeiro/agendamentos.php" class="btn btn-outline-primary btn-sm btn-text-white">
              <i class="bi bi-calendar-check me-2"></i>
              Ver Agendamentos
            </a>
            <a href="/barbeiro/horarios.php" class="btn btn-outline-secondary btn-sm">
              <i class="bi bi-clock me-2"></i>
              Gerenciar Horários
            </a>
            <a href="/barbeiro/servicos.php" class="btn btn-outline-info btn-sm">
