    ...
    <div class="row min-vh-100 align-items-center">
      <div class="col-lg-6 hero-content">
        ...
        <div class="hero-buttons fade-in-up">
          <a href="/auth/cliente_register.php" class="btn btn-hero-primary">
            <i class="bi bi-person-plus me-2"></i>
            Começar como Cliente
            <i class="bi bi-arrow-right ms-2"></i>
          </a>
          <a href="/auth/barbeiro_register.php" class="btn btn-hero-outline">
            <i class="bi bi-scissors me-2"></i>
            Sou Barbeiro
          </a>
        </div>
  ...
  <div class="featured-section">
    <div class="container">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="barber-card fade-in-up">
              ...
              <div class="barber-info">
                ...
                <a href="/auth/cliente_register.php" class="btn btn-barber-card text-light-gray">
      ...
      <div class="text-center mt-5">
        <a href="/auth/cliente_register.php" class="btn btn-featured-main text-light-gray">
          <i class="bi bi-person-plus me-2"></i>
      ...
      <div class="col-lg-8 mx-auto text-center">
        <div class="cta-content">
          ...
          <div class="cta-buttons fade-in-up">
            <a href="/auth/cliente_register.php" class="btn btn-cta-primary">
              <i class="bi bi-person-plus me-2"></i>
              Começar como Cliente
              <i class="bi bi-arrow-right ms-2"></i>
            </a>
            <a href="/auth/barbeiro_register.php" class="btn btn-cta-outline">
              <i class="bi bi-scissors me-2"></i>
              Cadastrar Barbearia
            </a>
          </div>
          ...
          <div class="login-links">
            ...
            <div class="login-buttons">
              <a href="/auth/cliente_login.php" class="btn-link-gold">
                <i class="bi bi-box-arrow-in-right me-1"></i>
                Login Cliente
              </a>
              <span class="divider">|</span>
              <a href="/auth/barbeiro_login.php" class="btn-link-gold">
