...
$data_agendamento = new DateTime($dados['data_agendamento'] . ' ' . $dados['horario']);
$agora = new DateTime();
...
if ($data_agendamento < $agora) {
  ...
  $horario->reativarHorario($dados['barbeiro_id'], $dados['data_agendamento'], $dados['horario']);
              ...
              <div class="col-md-6">
                ...
                <table class="table table-sm" style="background: rgba(30, 30, 30, 0.4); border-radius: var(--border-radius); overflow: hidden;">
                  ...
                  <tr>
                    ...
                    <td><?= formatDate($dados['data_agendamento']) ?></td>
                  </tr>
                  <tr>
                    <td><strong>Horário:</strong></td>
                    <td><?= date('H:i', strtotime($dados['horario'])) ?></td>
                  </tr>
                  <tr>
