...
$breadcrumb = [
  ['title' => 'Dashboard', 'url' => '/cliente/dashboard.php'],
  ['title' => 'Novo Agendamento']
];
...
<div class="row">
  <div class="col-12">
    <?php renderBackButton('/cliente/dashboard.php'); ?>
        ...
        <?php if ($barbeiro_id && $servico_id && $data_agendamento): ?>
          <form method="POST">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="/cliente/dashboard.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Cancelar</a>
            </div>
          </form>
        <?php endif; ?>
      </div>
